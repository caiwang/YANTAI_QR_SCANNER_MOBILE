    ...
    return(       
      ...
      <ScrollView style={styles.flexbox}>
          ...
          <View style={styles.items}>
              ...
              <TextInput placeholder=' 填写发运单号' style={styles.contentfont}  ></TextInput>
              <Button title="确定"  onPress={()=>alert('123')}>确定</Button>
          </View>
          ...
          <View style={styles.items}>
              <Text style={styles.font} onPress={this.Code.bind(this)} numberOfLines={1}>1.待发货单：12345678910
              </Text>
         ...
         {/* // <View style={[styles.itemsbottom,styles.itemss]}>
          //   <View>
          //   <Text style={styles.bigfont}>已发运列表</Text>
          //   </View>
