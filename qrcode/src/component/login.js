    ...
    return(
      ...
      <View style={styles.flexbox}>
        ...
        <View style={styles.admin}>
           ...
           <View><TextInput placeholder='password' placeholderTextColor="#888" maxLength={5} keyboardType='numeric' style={styles.contentfont}  secureTextEntry={true} onChangeText={(password)=>{this.setState({password:password})}} value={password} 
