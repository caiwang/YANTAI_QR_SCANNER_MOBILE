...
class Shipment extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.jiankong == "true") {
      //储运员获取发运单数量
      axios
        .get(`${url}/invoice/GetSum?id=${ID}&userInfoID=${userInfoID}`)
        .then((res) => {
          this.setState({
      ...
      axios
        .get(
          `${url}/invoice/GetListNoGroupSum?id=${ID}&&timestamp=${timestamp}`
        )
        .then((res) => {
          this.setState({
            loading: false,
      ...
      //理货员获取发运单数量
      axios
        .get(`${url}/invoice/GetSumList?id=${ID}&&userInfoID=${userInfoID}`)
        .then((res) => {
          this.setState({
            all: res.data[0],
            wait: res.data[1],
      ...
      // let timestamp = Date.parse(new Date());
      axios
        .get(`${url}/invoice/GetListNoGroup?id=${ID}&&timestamp=${timestamp}`)
        .then((res) => {
          this.setState({
            loading: false,
            searchlistshow: false,
  ...
  sx() {
    ...
    axios
      .post(`${url}/invoice/GetListNoGroupByUserInfoId`, data)
      .then((res) => {
        this.setState({
          loading: false,
          mydatalistshow: true,
  ...
  wwcsx() {
    ...
    axios
      .post(`${url}/invoice/GetListGroupByUserInfoId`, data)
      .then((res) => {
        this.setState({
          loading: false,
          mydatalistshow: false,
          myundatalistshow: true,
          searchlistshow: false,
          alldatalistshow: false,
          waitdatalistshow: false,
          unfinishdatalistshow: false,
  ...
  sousuo() {
    if (this.state.text != "") {
      axios
        .get(`${url}/invoice/Query?query=${this.state.text}`)
        .then((res) => {
          this.setState({
            loading: false,
            searchlistshow: true,
  ...
  alldatalist() {
    ...
    let timestamp = Date.parse(new Date());
    axios
      .get(`${url}/invoice/GetListByCompanyID?id=${ID}&&timestamp=${timestamp}`)
      .then((res) => {
        this.setState({
          loading: false,
          mydatalistshow: false,
  ...
  unfinishdatalist() {
    ...
    axios
      .get(`${url}/invoice/GetListGroupNoUser?id=${ID}&&timestamp=${timestamp}`)
      .then((res) => {
        console.log(res);
        this.setState({
          loading: false,
  ...
  finishdatalist() {
    ...
    axios
      .get(
        `${url}/invoice/QueryFlagTrueByToday?companyID=${ID}&&timestamp=${timestamp}`
      )
      .then((res) => {
        this.setState({
          loading: false,
  ...
  nulldatalist() {
    ...
    axios
      .get(
        `${url}/RFIDGroup/GetListBycompanyID?id=${ID}&&timestamp=${timestamp}`
      )
      .then((res) => {
        this.setState({
          loading: false,
  ...
  checkbox(index, item) {
    ...
    axios
      .post(`${url}/invoice/adduserinfo`, data)
      .then((res) => {
        this.addmy(res);
      })
      .catch((err) => {
  ...
  checkboxweiwancheng(index, item) {
    ...
    axios
      .post(`${url}/invoice/adduserinfo`, data)
      .then((res) => {
        this.checkboxweiwanchengok(res);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  checkboxweiwanchengok(res) {
    if (res.data == true) {
      ...
      let timestamp = Date.parse(new Date());
      axios
        .get(`${url}/invoice/GetListGroup?id=${ID}&&timestamp=${timestamp}`)
        .then((res) => {
          this.setState({
            loading: false,
            searchlistshow: false,
  ...
  checkboxcancel(index, item) {
    ...
    axios
      .post(`${url}/invoice/removeuserinfo`, data)
      .then((res) => {
        this.cancelmy(res);
      })
      .catch((err) => {
  ...
  checkboxwodeweiwancheng(index, item) {
    ...
    axios
      .post(`${url}/invoice/removeuserinfo`, data)
      .then((res) => {
        this.checkboxwodeweiwanchengok(res);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  tochuyunyuan(zhuangtai) {
    ...
    if (zhuangtai == "daifayun") {
      ...
      axios
        .get(
          `${url}/invoice/GetListByCompanyID?id=${ID}&&timestamp=${timestamp}`
        )
        .then((res) => this.getchuyunyuanlistok(res, zhuangtai))
        .catch((err) => console.log(err));
    }
          ...
          <View style={{ position: "absolute", top: 10 }}>
            ...
            >
              <Text
                ...
                onPress={this.tochuyunyuan.bind(this, "daifayun")}
              >
                待发货单
              </Text>
              <View
              ...
              >
                ...
                >
                  {this.state.chuyunyuandaifayunshuliang}
                </Text>
              </View>
            </View>
            ...
            >
              <Text
                ...
                onPress={this.tochuyunyuan.bind(this, "weiwancheng")}
              >
                未完成发货单
              </Text>
              <View
              ...
              >
                ...
                >
                  {this.state.chuyunyuanweiwanchengshuliang}
                </Text>
              </View>
            </View>
            ...
            >
              <Text
                ...
                onPress={this.tochuyunyuan.bind(this, "yiwancheng")}
              >
                已完成发货单
              </Text>
              <View
              ...
              >
                ...
                >
                  {this.state.chuyunyuanyiwanchengshuliang}
                </Text>
              </View>
            </View>
            ...
            >
              <Text
                ...
                onPress={this.tochuyunyuan.bind(this, "quanbu")}
              >
                全部发货单
              </Text>
              <View
              ...
              >
                ...
                >
                  {this.state.chuyunyuanquanbushuliang}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={{ position: "absolute", top: 10 }}>
            ...
            >
              <Text
                ...
                onPress={this.waitdatalist.bind(this)}
              >
                待发货单
              </Text>
              <View
            ...
            >
              <Text
                ...
                onPress={this.unfinishdatalist.bind(this)}
              >
                未完成发货单
              </Text>
              <View
            ...
            >
              <Text
                ...
                onPress={this.finishdatalist.bind(this)}
              >
                已完成发货单
              </Text>
              <View
            ...
            >
              <Text
                ...
                onPress={this.alldatalist.bind(this)}
              >
                全部发货单
              </Text>
              <View
            ...
            >
              <Text
                ...
                onPress={this.mydatalist.bind(this)}
              >
                我的待发运
              </Text>
              <View
            ...
            >
              <Text
                ...
                onPress={this.myundatalist.bind(this)}
              >
                我的未完成
              </Text>
              <View
            ...
            ? this.state.chuyunyuanlistdata.map((item, index) => (
                <View style={styles.itemss} key={index}>
                  <Text style={styles.font} numberOfLines={2}>
                    {index + 1}.车牌{item.plateNumber}订单{item.no}
                  </Text>
                  <Text
                    style={styles.fontxiangxi}
                    onPress={this.chuyunyuanxiangxixinxi.bind(
                      this,
                      index,
                      item
                    )}
            ...
            ? this.state.datalist.map((item, index) => {
                return (
                  <View style={styles.itemss} key={index}>
                    ...
                    <Text
                      style={styles.fontxiangxi}
                      onPress={this.UnFinishQRcode.bind(this, index, item)}
                      numberOfLines={1}
                    >
                      详情
                    </Text>
            ...
            ? this.state.datalist.map((item, index) => {
                return (
                  <View style={styles.itemss} key={index}>
                    ...
                    <Text
                      style={styles.fontxiangxi}
                      onPress={this.FinishQRcode.bind(this, index, item)}
                      numberOfLines={1}
                    >
                      详细信息
                    </Text>
            ...
            <View>
              ...
              >
                <Text
                  ...
                  onPress={this.NullQRcode.bind(this)}
                >
                  空单发运
                </Text>
              </View>
            ...
            ? this.state.datalist.map((item, index) => {
                return (
                  <View style={styles.itemss} key={index}>
                    ...
                    <Text
                      style={styles.fontxiangxi}
                      onPress={this.NullQRcodexx.bind(this, index, ite)}
                      numberOfLines={1}
                    >
                      详细信息
                    </Text>
            ...
            ? this.state.datalist.map((item, index) => {
                return (
                  <View style={styles.itemss} key={index}>
                    ...
                    <Text
                      style={styles.fontxiangxi}
                      onPress={this.AllQRcode.bind(this, index, item)}
                      numberOfLines={1}
                    >
                      详细信息
                    </Text>
        ...
        {this.state.loading ? (
          ...
          <View
            style={{
              position: "relative",
              width: width,
              height: this.state.nheight * 0.12 * height,
            }}
          >
            <SideMenu
              menu={menu}
              ...
              onChange={(isOpen) => {
                isOpen
                  ? this.setState({ sidewidth: 80, isOpen: true })
                  : this.setState({ sidewidth: 0, isOpen: false });
              }}
            >
              <View
                style={{
                  ...
                  <View>
                    ...
                    >
                      <View style={styles.items}>
                        ...
                        ></TextInput>
                        <Text onPress={this.sousuo.bind(this)}>
                          <Icon name="search" size={60} color="#444" />
                        </Text>
                      </View>
                    </View>
                  </View>
                      ...
                      ? this.state.datalist.map((item, index) => {
                          return (
                            <View style={styles.itemss} key={index}>
                              ...
                              <Text
                                style={styles.fontxiangxi}
                                onPress={this.SearchMessage.bind(this, index)}
                                numberOfLines={1}
                              >
                                详细信息
                              </Text>
