  ...
  render(){
    return(       
      <ScrollView style={styles.flexbox}>
            ...
            <View style={styles.itemss}><Text style={styles.fontwidth}>已读取二维码个数</Text><Text style={styles.fontwidth}> 5</Text></View>
              ...
              <View style={styles.adminn}>
                  ...
                  <View style={[styles.adminbtnn,styles.adminbtnnleft]}>
                    <Button title="确定完成" color="#4ea3f1" onPress={()=>alert('好喜欢你！')}>确定完成</Button>
                  </View>
             </View>
