...
class Shipment extends React.Component{
    ...
    Message(index){
      ...
      let arrcodelist=this.props.arrcodelist;
      let ididid=this.props.qrcodeidid;
      Actions.Message({listindex,arrcodelist,ididid});
    }
              ...
              {/*遍历列表*/}
              {
                ...
                this.state.show?this.state.list.map((item,index)=>{
                  ...
                  <View style={styles.items} key={index}>
                    ...
                    <Text style={styles.fontxiangxi} onPress={this.Message.bind(this,index)} numberOfLines={1}>详细信息
                    </Text>
                  </View> ) } ):null
              ...
              {/*搜索结果*/}
              {
                this.state.showsearch?this.state.list.map((item,index)=>{
                  ...
                  <View style={styles.items} key={index}>
                    ...
                    <Text style={styles.fontxiangxi} onPress={this.Message.bind(this,index)} numberOfLines={1}>详细
                    </Text>
                  </View> ) } ):null
